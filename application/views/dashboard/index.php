<div class="d-sm-flex align-items-center justify-content-between mb-3">
	<h6 class="h6 mb-0 text-gray-800">Selamat datang, Admin</h6>
	<ol class="breadcrumb">
...
<div class="row mb-3">
	...
	<div class="col-xl-3 col-md-6 mb-4">
		<div class="card h-100">
			...
			<div class="row align-items-center">
				...
				<div class="h5 mb-0 font-weight-bold text-gray-800"><?= format_rp($pendapatan) ?></div>
	...
	<div class="col-xl-3 col-md-6 mb-4">
		<div class="card h-100">
			...
			<div class="row no-gutters align-items-center">
				<div class="col mr-2">
				<div class="text-xs font-weight-bold text-uppercase mb-1">Transaksi Baru (Perhari)</div>
	...
	<div class="col-xl-3 col-md-6 mb-4">
		<div class="card h-100">
			...
			<div class="row no-gutters align-items-center">
				...
				<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $member_baru ?></div>
				<div class="mt-2 mb-0 text-muted text-xs">
	...
	<div class="col-xl-4 col-lg-5">
		<div class="card mb-4">
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
			<h6 class="m-0 font-weight-bold text-primary">Best Parfum</h6>
			<div class="dropdown no-arrow">
